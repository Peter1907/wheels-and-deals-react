...
const NewReservation = () => {
  ...
  return (
    <div className="mb-2 text-white flex flex-col items-center justify-center absolute w-full bg-cover bg-center bg-[url('/src/assets/form_reservation_bg01.png')] lg:object-cover sm:h-full">
      <div id="heading" className="p-4 font-bold text-base w-full flex items-center justify-between top-0 left-0 right-0">
      ...
      <NavLink to="/" className="w-full block flex justify-center">
        <img className="items-center self-center w-16 self-center mt-4 sm:w-20" src="./logo.svg" alt="logo" />
      </NavLink>
