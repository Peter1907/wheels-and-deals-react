...
const NewReservation = () => (
  <div className="text-white flex flex-col items-center justify-center absolute w-full h-full object-cover bg-cover bg-center bg-[url('/src/assets/form_reservation_bg01.png')]">
    <div className="space-x-2.5 p-8 font-bold text-base w-full flex center fixed top-0 left-0 right-0">
      <div className="border-white border-2 bg-lime-500 rounded-full px-4 py-2 mt-2">Cindy Dorantes</div>
