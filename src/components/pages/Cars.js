...
const Cars = () => {
  ...
  return (
    <div className="cars-page">
      <div className="navigation hidden float-left py-8 w-[250px] bg-slate-100 h-screen lg:block">
        <Link to="/">
          <img className="w-24 mx-auto" src="./logo.svg" alt="logo" />
        </Link>
        <ul className="flex flex-col mt-16 ml-4">
          <li className="py-4 text-2xl font-semibold pl-8 bg-green text-white">MODELS</li>
          <li className="py-4 text-2xl font-semibold pl-8">LIFESTYLE</li>
          <li className="py-4 text-2xl font-semibold pl-8">SHOP</li>
          <li className="py-4 text-2xl font-semibold pl-8">TEST DRIVE</li>
        </ul>
      </div>
      <div className="main-section flex flex-col relative justify-center">
        ...
        <div className="max-w-min w-[100%] self-center">
          <div className={`cars-container m-2 px-4 pb-4 flex gap-8 w-[${width}px] overflow-scroll md:mt-8`}>
            {data.map((car) => (
